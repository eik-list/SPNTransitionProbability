...
#ifndef _AES_BYTE_TRANSITION_ALGORITHM_H
#define _AES_BYTE_TRANSITION_ALGORITHM_H
...
class AESByteTransitionAlgorithm {

public:

    AESByteTransitionAlgorithm();
...
#endif // _AES_BYTE_TRANSITION_ALGORITHM_H
