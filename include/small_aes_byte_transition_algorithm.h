...
#ifndef _SMALL_AES_BYTE_TRANSITION_ALGORITHM_H
#define _SMALL_AES_BYTE_TRANSITION_ALGORITHM_H
...
class SmallAESByteTransitionAlgorithm {

public:

    SmallAESByteTransitionAlgorithm();
    ...
    void computeOutputProbabilityForAES(
        NTL::RR &probability,
...
#endif // _SMALL_AES_BYTE_TRANSITION_ALGORITHM_H
