...
#ifndef _SMALL_AES_COLUMN_TRANSITION_ALGORITHM_H
#define _SMALL_AES_COLUMN_TRANSITION_ALGORITHM_H
...
class SmallAESColumnTransitionAlgorithm {

public:

    SmallAESColumnTransitionAlgorithm();
...
#endif //_SMALL_AES_COLUMN_TRANSITION_ALGORITHM_H
