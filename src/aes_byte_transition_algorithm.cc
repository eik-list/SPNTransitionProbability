...
AESByteTransitionAlgorithm::AESByteTransitionAlgorithm() {
    initializeConstants();
}

// ------------------------------------------------------------------------

void AESByteTransitionAlgorithm::buildFirstByteDistribution(
...
void AESByteTransitionAlgorithm::buildFirstDiagonalDistribution(
    NTL::vec_RR &distribution) const {
...
void AESByteTransitionAlgorithm::buildSingleElementDistribution(
...
void AESByteTransitionAlgorithm::precomputeShiftRowsMatrix() {
    // ------------------------------------------------------------------------
...
void AESByteTransitionAlgorithm::precomputeMixColumnsMatrix() {
    // ------------------------------------------------------------------------
...
void AESByteTransitionAlgorithm::readZTable(const std::string &path) {
    NTL::ZZ Z_ZZ[16][16];
...
bool AESByteTransitionAlgorithm::haveMatricesBeenPrecomputed() const {
...
void AESByteTransitionAlgorithm::createMatrix(NTL::mat_RR &matrix,
...
void AESByteTransitionAlgorithm::applyMixColumns(
...
void AESByteTransitionAlgorithm::applyShiftRows(
    NTL::vec_RR &bytePatternDistribution) const {
    NTL::vec_RR result;
...
void AESByteTransitionAlgorithm::computeOutputProbabilityForAES(
    NTL::RR &probability,
...
void AESByteTransitionAlgorithm::computeOutputProbabilityForPRP(
    NTL::RR &probability,
